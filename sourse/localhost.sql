...
--
-- Хост: localhost
-- Время создания: Окт 09 2019 г., 10:46
...
--
-- База данных: `passwords`
--
CREATE DATABASE IF NOT EXISTS `passwords` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `passwords`;

-- --------------------------------------------------------

--
-- Структура таблицы `Пароли`
--
...
--
-- Дамп данных таблицы `Пароли`
--

INSERT INTO `Пароли` (`login`, `password`) VALUES
('test', '00001'),
('hackerman', '25549'),
('god', '123'),
('test1', '4'),
...
('root', '[{\"db\":\"passwords\",\"table\":\"\\u041f\\u0430\\u0440\\u043e\\u043b\\u0438\"}]');
...
('root', '2019-10-09 08:44:34', '{\"lang\":\"ru\",\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
